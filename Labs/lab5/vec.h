...
//new non-member function for lab5
template <class T> unsigned int remove_matching_elements(Vec<T>& v, const T& t){
...
//print function for lab5
template <class T> void Vec<T>::print(){
  std::cout << "Printing:\nm_size: " << m_size;
  std::cout << ",  m_alloc: " << m_alloc << endl;
  std::cout << "m_data: " << *m_data << endl << endl;
}
